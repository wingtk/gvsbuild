 * Download [HarfBuzz 0.9.35](http://cgit.freedesktop.org/harfbuzz/snapshot/harfbuzz-0.9.35.tar.gz)
 ...
 * Generate .def file:
	...
	* Start VS2012 Command Prompt
	<pre>cd C:\mozilla-build\hexchat\build\Win32\harfbuzz-0.9.35\win32\libs\Release
