 * Download [HarfBuzz 0.9.27](http://cgit.freedesktop.org/harfbuzz/snapshot/harfbuzz-0.9.27.tar.gz)
 ...
 * Generate .def file:
	...
	* Start VS2012 Command Prompt
	<pre>cd C:\mozilla-build\hexchat\build\Win32\harfbuzz-0.9.27\win32\libs\Release
