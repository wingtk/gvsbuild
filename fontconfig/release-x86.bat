...
copy Release\fontconfig.pdb %FONTCONFIG_DEST%\bin
copy Release\fc-cache.exe %FONTCONFIG_DEST%\bin
copy Release\fc-cache.pdb %FONTCONFIG_DEST%\bin
copy Release\fc-cat.exe %FONTCONFIG_DEST%\bin
copy Release\fc-cat.pdb %FONTCONFIG_DEST%\bin
copy Release\fc-list.exe %FONTCONFIG_DEST%\bin
copy Release\fc-list.pdb %FONTCONFIG_DEST%\bin
copy Release\fc-match.exe %FONTCONFIG_DEST%\bin
copy Release\fc-match.pdb %FONTCONFIG_DEST%\bin
copy Release\fc-query.exe %FONTCONFIG_DEST%\bin
copy Release\fc-query.pdb %FONTCONFIG_DEST%\bin
copy Release\fc-scan.exe %FONTCONFIG_DEST%\bin
copy Release\fc-scan.pdb %FONTCONFIG_DEST%\bin
