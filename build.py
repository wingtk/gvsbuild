...
class Project_gdk_pixbuf(Tarball, Project):
    def __init__(self):
        Project.__init__(self,
            'gdk-pixbuf',
            archive_url = 'http://ftp.acc.umu.se/pub/GNOME/sources/gdk-pixbuf/2.36/gdk-pixbuf-2.36.6.tar.xz',
            hash = '455eb90c09ed1b71f95f3ebfe1c904c206727e0eeb34fc94e5aaf944663a820c',
...
class Project_glib(Tarball, Project):
    def __init__(self):
        Project.__init__(self,
            'glib',
            archive_url = 'http://ftp.acc.umu.se/pub/GNOME/sources/glib/2.52/glib-2.52.0.tar.xz',
            hash = '4578e3e077b1b978cafeec8d28b676c680aba0c0475923874c4c993403df311a',
...
class Project_gtk3(Project_gtk_base):
    def __init__(self):
        Project_gtk_base.__init__(self,
            'gtk3',
            archive_url = 'http://ftp.acc.umu.se/pub/GNOME/sources/gtk+/3.22/gtk+-3.22.11.tar.xz',
            hash = 'db440670cb6f3c098b076df3735fbc4e69359bd605385e87c90ee48344a804ca',
...
class Project_wing(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            'wing',
            archive_url = 'https://git.gnome.org/browse/wing/snapshot/wing-0c06dfef06e3dd2af10fab3f7d98c2c336f84753.tar.xz',
            hash = '38cd4a8a8580b8abb1223759ba5f04ad03b4e397da14b2eadd745a00f2b15056',
            dependencies = ['ninja', 'meson', 'pkg-config', 'glib'],
            )
