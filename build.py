...
class Project_atk(Project):
    ...
    def build(self):
        self.exec_vs(r'msbuild build\win32\vs%(vs_ver)s\atk.sln /p:Platform=%(platform)s /p:Configuration=%(configuration)s /maxcpucount /nodeReuse:True')
...
class Project_cairo(Project):
    ...
    def build(self):
        self.exec_vs(r'msbuild msvc\vc%(vs_ver)s\cairo.sln /p:Platform=%(platform)s /p:Configuration=Release_FC /maxcpucount /nodeReuse:True')
...
class Project_fontconfig(Project):
    ...
    def build(self):
        ...
        self.exec_vs('msbuild fontconfig.sln /p:Platform=%(platform)s /p:Configuration=%(configuration)s /t:build /nodeReuse:True')
...
class Project_freetype(Project):
    ...
    def build(self):
        self.exec_vs(r'msbuild builds\windows\vc%(vs_ver)s\freetype.vcxproj /p:Platform=%(platform)s /p:Configuration=%(configuration)s /maxcpucount /nodeReuse:True')
...
class Project_gdk_pixbuf(Project):
    ...
    def build(self):
        self.exec_vs(r'msbuild build\win32\vs%(vs_ver)s\gdk-pixbuf.sln /p:Platform=%(platform)s /p:Configuration=Release_GDI+ /maxcpucount /nodeReuse:True')
...
class Project_glib(Project):
    ...
    def build(self):
        self.exec_vs(r'msbuild build\win32\vs%(vs_ver)s\glib.sln /p:Platform=%(platform)s /p:Configuration=%(configuration)s /maxcpucount /nodeReuse:True')
...
class Project_glib_networking(Project):
    ...
    def build(self):
        self.exec_vs(r'msbuild build\win32\vs%(vs_ver)s\glib-networking.sln /p:Platform=%(platform)s /p:Configuration=%(configuration)s /maxcpucount /nodeReuse:True')
...
class Project_gtk_base(Project):
    ...
    def build(self):
        self.exec_vs(r'msbuild build\win32\vs%(vs_ver)s\gtk+.sln /p:Platform=%(platform)s /p:Configuration=%(configuration)s /maxcpucount /nodeReuse:True')
...
class Project_libcroco(Project):
    ...
    def build(self):
        self.exec_vs(r'msbuild build\win32\vs%(vs_ver)s\libcroco.sln /p:Platform=%(platform)s /p:Configuration=%(configuration)s /maxcpucount /nodeReuse:True')
...
class Project_libepoxy(Project):
    ...
    def build(self):
        self.exec_vs(r'msbuild build\win32\vs%(vs_ver)s\epoxy.sln /p:Platform=%(platform)s /p:Configuration=%(configuration)s /maxcpucount /nodeReuse:True')
...
class Project_libffi(Project):
    ...
    def build(self):
        ...
        self.exec_vs(r'msbuild build\win32\vs%(vs_ver)s\libffi.sln /p:Platform=%(platform)s /p:Configuration=%(configuration)s /maxcpucount /nodeReuse:True')
...
class Project_libpng(Project):
    ...
    def build(self):
        self.exec_vs(r'msbuild projects\vc%(vs_ver)s\pnglibconf\pnglibconf.vcxproj /p:Platform=%(platform)s /p:Configuration=%(configuration)s /p:SolutionDir=%(build_dir)s\projects\vc%(vs_ver)s\ /nodeReuse:True')
        self.exec_vs(r'msbuild projects\vc%(vs_ver)s\libpng\libpng.vcxproj /p:Platform=%(platform)s /p:Configuration=%(configuration)s /p:SolutionDir=%(build_dir)s\projects\vc%(vs_ver)s\ /nodeReuse:True')
...
class Project_librsvg(Project):
    ...
    def build(self):
        self.exec_vs(r'msbuild build\win32\vs%(vs_ver)s\librsvg.sln /p:Platform=%(platform)s /p:Configuration=%(configuration)s /maxcpucount /nodeReuse:True')
...
class Project_libsoup(Project):
    ...
    def build(self):
        self.exec_vs(r'msbuild build\win32\vs%(vs_ver)s\soup.sln /p:Platform=%(platform)s /p:Configuration=%(configuration)s /maxcpucount /nodeReuse:True')
...
class Project_libxml2(Project):
    ...
    def build(self):
        self.exec_vs(r'msbuild win32\vc%(vs_ver)s\libxml2.sln /p:Platform=%(platform)s /p:Configuration=%(configuration)s /maxcpucount /nodeReuse:True')
...
class Project_lmdb(Project):
    ...
    def build(self):
        self.exec_vs(r'msbuild libraries\liblmdb\lmdb.sln /p:Platform=%(platform)s /p:Configuration=%(configuration)s /maxcpucount /nodeReuse:True')
...
class Project_pango(Project):
    ...
    def build(self):
        self.exec_vs(r'msbuild build\win32\vs%(vs_ver)s\pango.sln /p:Platform=%(platform)s /p:Configuration=Release_FC /nodeReuse:True')
...
class Project_pixman(Project):
    ...
    def build(self):
        ...
        self.exec_vs(r'msbuild build\win32\vc%(vs_ver)s\pixman.vcxproj /p:Platform=%(platform)s /p:Configuration=%(configuration)s /p:SolutionDir=%(build_dir)s\build\win32\vc%(vs_ver)s\ /maxcpucount /nodeReuse:True')
        self.exec_vs(r'msbuild build\win32\vc%(vs_ver)s\install.vcxproj /p:Platform=%(platform)s /p:Configuration=%(configuration)s /p:SolutionDir=%(build_dir)s\build\win32\vc%(vs_ver)s\ /maxcpucount /nodeReuse:True')
...
class Project_zlib(Project):
    ...
    def build(self):
        self.exec_vs(r'msbuild build\win32\vs%(vs_ver)s\zlib.sln /p:Platform=%(platform)s /p:Configuration=%(configuration)s /maxcpucount /nodeReuse:True')
    ...
    def __sub_vars(self, s):
        if '%' in s:
            d = dict(platform=self.opts.platform, configuration=self.opts.configuration, build_dir=self.opts.build_dir, vs_ver=self.opts.vs_ver,
                     gtk_dir=self.gtk_dir, python_dir=self.opts.python_dir, perl_dir=self.opts.perl_dir)
