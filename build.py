...
class Project_gtk3(Project_gtk_base):
    def __init__(self):
        Project_gtk_base.__init__(self,
            'gtk3',
            archive_url = 'http://ftp.acc.umu.se/pub/GNOME/sources/gtk+/3.20/gtk+-3.20.8.tar.xz',
            dependencies = ['atk', 'gdk-pixbuf', 'pango', 'libepoxy'],
            patches = ['0001-Use-g_snprintf-instead-of-snprintf.patch'],
            )
...
class Project_wing(Tarball, Project):
    def __init__(self):
        Project.__init__(self,
            'wing',
            archive_url = 'https://git.gnome.org/browse/wing/snapshot/wing-11c2317cc00c7c0503442c336ca79074cdf10254.tar.xz',
            dependencies = ['glib'],
            )
