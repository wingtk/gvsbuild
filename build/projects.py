...
from build.build_utils import Tarball, Project, GitRepo, Meson, MercurialCmakeProject
from build.build_utils import print_debug, convert_to_msys
...
if __name__ == '__main__':
    ...
    for name in Project.get_names():
        p = Project.get_project(name)
        print('    %-20s %s' % (name, p.archive_url, ))
