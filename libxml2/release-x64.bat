...
copy win32\vc12\x64\Release\runsuite.exe .
set PATH=%PATH%;..\..\..\gtk\x64\bin;win32\vc12\x64\Release
runsuite.exe
del runsuite.exe
set LIBXML_SRC=%cd%
...
copy win32\vc12\x64\Release\libxml2.dll %LIBXML_DEST%\bin
copy win32\vc12\x64\Release\libxml2.pdb %LIBXML_DEST%\bin
copy win32\vc12\x64\Release\runsuite.exe %LIBXML_DEST%\bin
copy win32\vc12\x64\Release\runsuite.pdb %LIBXML_DEST%\bin
copy win32\vc12\x64\Release\libxml2.lib %LIBXML_DEST%\lib
