...
$items = @{
	...
	'gdk-pixbuf' = @{
		'ArchiveUrl' = 'http://ftp.acc.umu.se/pub/GNOME/sources/gdk-pixbuf/2.32/gdk-pixbuf-2.32.1.tar.xz'
...
$items['gsettings-desktop-schemas'].BuildScript = {
	...
	Exec nmake /f gsettings-desktop-schemas-msvc.mak PYTHON=`"c:\Python27\python.exe`" PYTHON2=`"c:\Python27\python.exe`" PERL=`"$PerlDirectory\$platform\bin\perl.exe`"  PREFIX=`"$workingDirectory\..\..\gtk\$platform`"
