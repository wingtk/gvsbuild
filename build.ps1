...
$items = @{
	'atk' = @{
		'ArchiveUrl' = 'http://dl.hexchat.net/gtk-win32/src/atk-2.14.0.tar.xz'
		'Dependencies' = @('glib')
	};
	...
	'glib' = @{
		'ArchiveUrl' = 'http://dl.hexchat.net/gtk-win32/src/glib-2.42.2.tar.xz'
	...
	'harfbuzz' = @{
		'ArchiveUrl' = 'http://dl.hexchat.net/gtk-win32/src/harfbuzz-0.9.39.tar.bz2'
	...
	'libpng' = @{
		'ArchiveUrl' = 'http://dl.hexchat.net/gtk-win32/src/libpng-1.6.16.tar.xz'
		'Dependencies' = @('zlib')
	};
	...
	'openssl' = @{
		'ArchiveUrl' = 'http://dl.hexchat.net/gtk-win32/src/openssl-1.0.1m.tar.gz'
		'Dependencies' = @()
	};
