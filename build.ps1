...
$items = @{
	...
	'pango'            = @{ 'ArchiveUrl' = 'http://dl.hexchat.net/gtk-win32/src/pango-1.36.5.7z';         'Dependencies' = @('cairo', 'harfbuzz')                 };
...
$items['pango'].BuildScript = {
	...
	Exec msbuild build\win32\vc12\pango.sln /p:Platform=$platform /p:Configuration=Release_FC /nodeReuse:True
