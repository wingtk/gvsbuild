...
class Freetype(Tarball, Meson):
    def __init__(self):
        Project.__init__(
            ...
            archive_url="https://downloads.sourceforge.net/project/freetype/freetype2/{version}/freetype-{version}.tar.xz",
            hash="4b62dcab4c920a1a860369933221814362e699e26f55792516d671e6ff55b5e1",
