...
class Harfbuzz(Tarball, Meson):
    def __init__(self):
        Project.__init__(
            self,
            "harfbuzz",
            archive_url="https://github.com/harfbuzz/harfbuzz/releases/download/4.0.1/harfbuzz-4.0.1.tar.xz",
            hash="98f68777272db6cd7a3d5152bac75083cd52a26176d87bc04c8b3929d33bce49",
