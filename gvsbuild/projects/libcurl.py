...
class Libcurl(Tarball, CmakeProject):
    def __init__(self):
        Project.__init__(
            self,
            "libcurl",
            archive_url="https://github.com/curl/curl/releases/download/curl-7_82_0/curl-7.82.0.tar.gz",
            hash="910cc5fe279dc36e2cca534172c94364cf3fcf7d6494ba56e6c61a390881ddce",
            dependencies=[
                "perl",
                "cmake",
                "ninja",
