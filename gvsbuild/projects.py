...
class Project_gtk3_24(Tarball, Meson):
    def __init__(self):
        ...
        Project.__init__(self,
            'gtk3',
            prj_dir='gtk3-24',
            archive_url = 'http://ftp.acc.umu.se/pub/GNOME/sources/gtk+/3.24/gtk+-3.24.26.tar.xz',
            hash = '2cc1b2dc5cad15d25b6abd115c55ffd8331e8d4677745dd3ce6db725b4fff1e9',
            dependencies = ['atk', 'gdk-pixbuf', 'pango', 'libepoxy'],
            patches = [
...
class Project_harfbuzz(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            'harfbuzz',
            archive_url = 'https://github.com/harfbuzz/harfbuzz/releases/download/2.7.4/harfbuzz-2.7.4.tar.xz',
...
class Project_openssl(Tarball, Project):
    def __init__(self):
        Project.__init__(self,
            'openssl',
            archive_url = 'https://www.openssl.org/source/openssl-1.1.1j.tar.gz',
            hash = 'aaf2fcb575cdf6491b98ab4829abf78a3dec8402b8b81efc8f23c00d443981bf',
...
class Project_pango(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            'pango',
            archive_url = 'http://ftp.acc.umu.se/pub/GNOME/sources/pango/1.48/pango-1.48.2.tar.xz',
            hash = 'd21f8b30dc8abdfc55de25656ecb88dc1105eeeb315e5e2a980dcef8010c2c80',
            dependencies = [
                'ninja',
                'meson',
                'cairo',
