...
class Project_adwaita_icon_theme(Tarball, Project):
    def __init__(self):
        Project.__init__(self,
            'adwaita-icon-theme',
            archive_url = 'http://ftp.acc.umu.se/pub/GNOME/sources/adwaita-icon-theme/3.34/adwaita-icon-theme-3.34.0.tar.xz',
            hash = '40b7e91f8263552b64d0f9beff33150291b086618ce498c71bf10035e48c7c7f',
...
class Project_ffmpeg(Tarball, Project):
    def __init__(self):
        Project.__init__(self,
            'ffmpeg',
            archive_url = 'https://www.ffmpeg.org/releases/ffmpeg-4.2.1.tar.xz',
            hash = 'cec7c87e9b60d174509e263ac4011b522385fd0775292e1670ecc1180c9bb6d4',
...
class Project_gdk_pixbuf(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            'gdk-pixbuf',
            archive_url = 'http://ftp.acc.umu.se/pub/GNOME/sources/gdk-pixbuf/2.38/gdk-pixbuf-2.38.2.tar.xz',
            hash = '73fa651ec0d89d73dd3070b129ce2203a66171dfc0bd2caa3570a9c93d2d0781',
            dependencies = [
                'ninja',
                'pkg-config',
                'meson',
...
class Project_glib(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            'glib',
            archive_url = 'http://ftp.acc.umu.se/pub/GNOME/sources/glib/2.62/glib-2.62.0.tar.xz',
            hash = '6c257205a0a343b662c9961a58bb4ba1f1e31c82f5c6b909ec741194abc3da10',
...
class Project_harfbuzz(Tarball, CmakeProject):
    def __init__(self):
        Project.__init__(self,
            'harfbuzz',
            archive_url = 'https://www.freedesktop.org/software/harfbuzz/release/harfbuzz-2.6.1.tar.xz',
            hash = 'c651fb3faaa338aeb280726837c2384064cdc17ef40539228d88a1260960844f',
...
class Project_libjpeg_turbo(Tarball, CmakeProject):
    def __init__(self):
        Project.__init__(self,
            'libjpeg-turbo',
            archive_url = 'https://sourceforge.net/projects/libjpeg-turbo/files/2.0.3/libjpeg-turbo-2.0.3.tar.gz',
            hash = '4246de500544d4ee408ee57048aa4aadc6f165fc17f141da87669f20ed3241b7',
...
class Project_openssl(Tarball, Project):
    def __init__(self):
        Project.__init__(self,
            'openssl',
            archive_url = 'https://www.openssl.org/source/openssl-1.0.2t.tar.gz',
            hash = '14cb464efe7ac6b54799b34456bd69558a749a4931ecfd9cf9f71d7881cac7bc',
