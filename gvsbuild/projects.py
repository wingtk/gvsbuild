...
class Project_gdk_pixbuf(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            'gdk-pixbuf',
            archive_url = 'http://ftp.acc.umu.se/pub/GNOME/sources/gdk-pixbuf/2.36/gdk-pixbuf-2.36.11.tar.xz',
            hash = 'ae62ab87250413156ed72ef756347b10208c00e76b222d82d9ed361ed9dde2f3',
...
class Project_glib(Tarball, Project):
    def __init__(self):
        Project.__init__(self,
            'glib',
            archive_url = 'http://ftp.acc.umu.se/pub/GNOME/sources/glib/2.52/glib-2.52.3.tar.xz',
...
class Project_harfbuzz(Tarball, Project):
    def __init__(self):
        Project.__init__(self,
            'harfbuzz',
            archive_url = 'https://www.freedesktop.org/software/harfbuzz/release/harfbuzz-1.6.3.tar.bz2',
            hash = 'e31eb367beb61a9399d2c78b51c225ab2b1cbd46f364f2d80d97bb422b44101a',
...
class Project_libpng(Tarball, CmakeProject):
    def __init__(self):
        Project.__init__(self,
            'libpng',
            archive_url = 'http://prdownloads.sourceforge.net/libpng/libpng-1.6.32.tar.xz',
            hash = 'c918c3113de74a692f0a1526ce881dc26067763eb3915c57ef3a0f7b6886f59b',
...
class Project_libsoup(Tarball, Project):
    def __init__(self):
        Project.__init__(self,
            'libsoup',
            archive_url = 'http://ftp.acc.umu.se/pub/GNOME/sources/libsoup/2.58/libsoup-2.58.2.tar.xz',
...
class Project_libxml2(Tarball, Project):
    def __init__(self):
        Project.__init__(self,
            'libxml2',
            archive_url = 'ftp://xmlsoft.org/libxml2/libxml2-2.9.5.tar.gz',
            hash = '4031c1ecee9ce7ba4f313e91ef6284164885cdb69937a123f6a83bb6a72dcd38',
            dependencies = ['win-iconv'],
            )
...
class Project_wing(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            'wing',
            archive_url = 'https://git.gnome.org/browse/wing/snapshot/wing-0.0.12.tar.xz',
            hash = '24572a6c9a875f0774091eafd7b1fa855dded85b00bc2ad863acf09f540080a8',
            dependencies = ['ninja', 'meson', 'pkg-config', 'glib'],
            )
