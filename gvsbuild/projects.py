...
class Project_harfbuzz(Tarball, CmakeProject):
    def __init__(self):
        Project.__init__(self,
            'harfbuzz',
            archive_url = 'https://www.freedesktop.org/software/harfbuzz/release/harfbuzz-2.4.0.tar.bz2',
            hash = '9035005903da74667d28bb181986e879e11da3d5986722759fa145cca781ead6',
...
class Project_libsoup(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            'libsoup',
            archive_url = 'http://ftp.acc.umu.se/pub/GNOME/sources/libsoup/2.66/libsoup-2.66.0.tar.xz',
            hash = '51adc2ad6c8c670cf6339fcfa88190a3b58135a9cddd21f623a0f80fdb9c8921',
...
class Project_wing(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            'wing',
            archive_url = 'https://gitlab.gnome.org/GNOME/wing/repository/v0.1.4/archive.tar.gz',
            archive_file_name = 'wing-0.1.4.tar.gz',
            hash = '6d7f540399609332a634106f2408b879ad309dba8c133afdb8214c2856e84b50',
            dependencies = ['ninja', 'meson', 'pkg-config', 'glib'],
            )
