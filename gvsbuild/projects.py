...
class Project_harfbuzz(Tarball, Meson):
    def __init__(self):
        Project.__init__(
            self,
            "harfbuzz",
            archive_url="https://github.com/harfbuzz/harfbuzz/releases/download/3.2.0/harfbuzz-3.2.0.tar.xz",
            hash="0ada50a1c199bb6f70843ab893c55867743a443b84d087d54df08ad883ebc2cd",
