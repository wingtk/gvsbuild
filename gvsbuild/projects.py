...
class Project_dcv_color_primitives(Tarball, Meson):
    def __init__(self):
        Meson.__init__(self,
            ...
            archive_url = 'https://github.com/aws/dcv-color-primitives/archive/v0.1.4.tar.gz',
            archive_file_name = 'dcv-color-primitives-0.1.4.tar.gz',
            hash = '29b84327d25d930c388f5b279c15fcc0cf3472d93922fb9001842e007d330630',
...
class Project_wing(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            'wing',
            archive_url = 'https://gitlab.gnome.org/GNOME/wing/-/archive/v0.2.2/wing-v0.2.2.tar.gz',
            hash = 'ffa05229417dc51923e9db7138988f16788919bbf3f9ecb5031de1a38cfd8f8d',
            dependencies = ['ninja', 'meson', 'pkg-config', 'glib'],
            )
