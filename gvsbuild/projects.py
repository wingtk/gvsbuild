...
class Project_dcv_color_primitives(Tarball, Meson):
    def __init__(self):
        Meson.__init__(self,
            ...
            archive_url = 'https://github.com/aws/dcv-color-primitives/archive/v0.3.0.tar.gz',
            archive_file_name = 'dcv-color-primitives-0.3.0.tar.gz',
            hash = '0d18992d89dab843b5b571deb504c4644fccdb3685fb4a763e9ff6f03c61fb51',
...
class Project_glib_networking(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            ...
            patches = ['0001-Use-the-keychain-CA-certificates-on-macos.patch',
                       '0002-Do-not-load-certificates-from-default-paths-on-MacOS.patch',
                       '0003-Loading-certificates-from-Windows-root-and-ca-stores.patch'],
            )
...
class Project_openssl(Tarball, Project):
    def __init__(self):
        Project.__init__(self,
            'openssl',
            archive_url = 'https://www.openssl.org/source/openssl-1.1.1l.tar.gz',
            hash = '0b7a3e5e59c34827fe0c3a74b7ec8baef302b98fa80088d7f9153aa16fa76bd1',
