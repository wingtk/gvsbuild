...
class Project_glib(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            'glib',
            archive_url = 'http://ftp.acc.umu.se/pub/GNOME/sources/glib/2.62/glib-2.62.2.tar.xz',
            hash = '698824a413f76df039739c2a78f45b10939d526ae7495bab4e694e6730deb3f1',
...
class Project_gtk3_24(Tarball, Meson):
    def __init__(self):
        ...
        Project.__init__(self,
            'gtk3',
            prj_dir='gtk3-24',
            archive_url = 'http://ftp.acc.umu.se/pub/GNOME/sources/gtk+/3.24/gtk+-3.24.12.tar.xz',
            hash = '1384eba5614fed160044ae0d32369e3df7b4f517b03f4b1f24d383e528f4be83',
            dependencies = ['atk', 'gdk-pixbuf', 'pango', 'libepoxy'],
            patches = [
